        ...
        <table>
            ...
            <tr>
                <td style="padding-left:100px;padding-top: 10px;">
                    <asp:Button ID="btn1" Text="1" runat="server" Height="37px" Style="margin-left: 0px"
                        Width="57px" />
            ...
            <tr>
                <td style="padding-left:100px">
                    <asp:Button ID="btn4" Text="4" runat="server" Height="37px" Style="margin-left: 0px"
                        Width="57px" />
            ...
            <tr>
                <td style="padding-left:100px">
                    <asp:Button ID="btn7" Text="7" runat="server" Height="37px" Style="margin-left: 0px"
                        Width="57px" />
            ...
            <tr>
                <td style="padding-left:100px">
                    <asp:Button ID="btn0" runat="server" Text="0" Height="37px" Style="margin-left: 0px"
                        Width="57px" />
                    <asp:Button ID="btnclr" runat="server" Text="CLR" Height="37px" Style="margin-left: 0px"
                        Width="57px" />
                    <asp:Button ID="btneql" runat="server" Text="=" Height="37px" Style="margin-left: 0px"
                        Width="57px" />
